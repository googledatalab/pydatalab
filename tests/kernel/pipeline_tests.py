...
default_args = {
    ...
    'email': ['foo@bar.com'],
    'start_date': datetime.datetime.strptime('2009-05-05 22:28:15Z', '%Y-%m-%dT%H:%M:%SZ').replace(tzinfo=timezone('UTC')),
    'end_date': datetime.datetime.strptime('2009-05-06 22:28:15Z', '%Y-%m-%dT%H:%M:%SZ').replace(tzinfo=timezone('UTC')),
