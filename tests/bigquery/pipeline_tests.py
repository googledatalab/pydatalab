...
WHERE endpoint=@endpoint""")
  ...
  def test_pipeline_cell_golden(self, mock_client_get_bucket, mock_client, mock_blob_class,
    ...
    env = {
      'endpoint': 'Interact2',
      'job_id': '1234',
      'input_table_format': 'cloud-datalab-samples.httplogs.logs_{ds_nodash}',
      'output_table_format': 'cloud-datalab-samples.endpoints.logs_{ds_nodash}'
    }
    ...
    cell_body = """
            ...
            schedule:
                ...
                interval: '@hourly'
            input:
                path: gs://bucket/cloud-datalab-samples-httplogs_{ds_nodash}
            ...
            transformation:
                query: foo_query
            output:
                path: gs://bucket/cloud-datalab-samples-endpoints_{ds_nodash}.csv
