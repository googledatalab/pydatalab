...
def parse_arguments(argv):
  ...
  parser.add_argument('--output-format',
                      ...
                      help="""
      The output results.
        json: produces a newline file where each line is json.
        csv: produces a csv file without a header row and a header csv file.
        bigquery: outout location needs to be in the from project_id.dataset.table
        """)
  ...
  if args.cloud:
    ...
    #TODO(brandondutra): check for io file errors
  return args
