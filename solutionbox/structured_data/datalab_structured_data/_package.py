...
class Local(object):
  ...
  @staticmethod
  def analysis(output_dir, dataset):
  ...
  @staticmethod
  def predict(training_ouput_dir, data):
...
class Cloud(object):
  ...
  @staticmethod
  def analysis(output_dir, dataset, project_id=None):
  ...
  @staticmethod
  def predict(model_name, model_version, data):
