...
def _create_airflow_parser():
  """ Create the parser for the %deploy magics.
  ...
  cell upon execution.
  """
  parser = google.datalab.utils.commands.CommandParser(prog='%deploy', description="""
...
_airflow_parser = _create_airflow_parser()


@IPython.core.magic.register_line_cell_magic
def deploy(line, cell=None):
  ...
  return google.datalab.utils.commands.handle_magic_line(line, cell, _airflow_parser,
                                                         namespace=namespace)
